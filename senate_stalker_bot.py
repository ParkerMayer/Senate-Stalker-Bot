...
while True:
    ...
    def calculate_and_tweet_1(df, senators_batch_1):                         # today is saturday
        ...
        for i in range(len(senators_batch_1)):
            tweet = str("Hey "+senators_batch_1[i]+"! Did you know that today, the level of CO2 in the atmosphere is "+todays_carbon_level+" parts per million? One year ago, it was "+last_years_carbon_level+" parts per million. Super cool, amirite? And it's thanks to your inaction! Source: https://carbon.datahub.io/# "+str(todays_date))
    ...
    def calculate_and_tweet_2(df, senators_batch_2):                         # today is sunday
        ...
        for i in range(len(senators_batch_2)):
            tweet = str("Hey "+senators_batch_2[i]+"! Here’s a fun reminder for you: today’s level of atmospheric CO2 is "+todays_carbon_level+" parts per million! A year ago, it was "+last_years_carbon_level+" parts per million. Wow, sure seems like something should be done about that! Source: https://carbon.datahub.io/# "+str(todays_date))
            api.update_status(status = (tweet))
            time.sleep(60)
    ...
    def calculate_and_tweet_3(df, senators_batch_3):                         # today is monday
        ...
        for i in range(len(senators_batch_3)):
            tweet = str("Hey "+senators_batch_3[i]+"! Did you know that today, the level of CO2 in the atmosphere is "+todays_carbon_level+" parts per million? One year ago, it was "+last_years_carbon_level+" parts per million. Super cool, amirite? And it's thanks to your inaction! Source: https://carbon.datahub.io/# "+str(todays_date))
            api.update_status(status = (tweet))
            time.sleep(60)
    # this function is the same as calculate_and_tweet_1,
    # with a different batch of senators
    def calculate_and_tweet_4(df, senators_batch_4):                         # today is tuesdayyy
        ...
        for i in range(len(senators_batch_4)):
            tweet = str("Hey "+senators_batch_4[i]+"! Here’s a fun reminder for you: today’s level of atmospheric CO2 is "+todays_carbon_level+" parts per million! A year ago, it was "+last_years_carbon_level+" parts per million. Wow, sure seems like something should be done about that! Source: https://carbon.datahub.io/# "+str(todays_date))
            api.update_status(status = (tweet))
            time.sleep(60)
